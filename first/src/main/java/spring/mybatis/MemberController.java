...
public class MemberController {
	...
	@RequestMapping("/")
	public String start() { return "mybatis/start"; }
	
	@GetMapping("/login")
	public String login() { return "mybatis/loginform"; }
	...
	public String memberinsert() { return "mybatis/memberinsert"; }
	...
	public ModelAndView  memberinsert(MemberDTO dto){
		...
		if(db_dto == null) {
			...
			if(row == 1) { insertresult ="정상회원가입처리"; }
			else { insertresult ="회원가입처리오류발생"; }
		}
		else insertresult = "이미 사용중인 아이디입니다.";
	...
	public ModelAndView memberinform(HttpSession session) {
		...
		else mv.setViewName("mybatis/loginform");
