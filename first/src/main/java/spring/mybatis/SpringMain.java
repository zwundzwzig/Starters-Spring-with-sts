...
public class SpringMain {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("=============================");
		for(String n :names) { System.out.println(n);//@ 3개, data연결객체 3개 }
		System.out.println("=============================");
		*/
		...
		for(MemberDTO m : list) { System.out.println(m.getId()+":"+m.getPw()+":"+m.getName()); }
		...
		*/
		...
		maria 글 3개 
		테스트후
		INSERT INTO member VALUES ('maria', 'maria', '김상형', '01099221234', 'sang@kil.net','제주시 애월동','2023-01-03 12:29:19');
		실행하기
		mybatis 글 없음
		테스트후
		test5,6다시 실행하기
